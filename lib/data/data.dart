...
final List<User> onlineUsers = [
  ...
  User(
    name: 'Julieta de Gimenez',
    imageUrl:
        'https://images.unsplash.com/photo-1528892952291-009c663ce843?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=592&q=80',
  ),
  User(
    name: 'Marisol Iriarte',
    imageUrl:
...
final List<Post> posts = [
  Post(
    user: currentUser,
    caption: 'Noche de michis :v',
    timeAgo: '58m',
    imageUrl:
        'https://t2.ea.ltmcdn.com/es/images/5/7/5/como_socializar_un_gato_cachorro_22575_600_square.jpg',
    likes: 1202,
    comments: 184,
    shares: 96,
  ),
  ...
  Post(
    user: onlineUsers[0],
    caption:
        'La vida se vuelve más fácil cuando aprendes a aceptar las disculpas que nunca recibiste',
    timeAgo: '1d',
    imageUrl: null,
    likes: 482,
    comments: 37,
